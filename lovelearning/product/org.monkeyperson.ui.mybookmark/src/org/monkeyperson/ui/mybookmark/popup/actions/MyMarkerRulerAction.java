package org.monkeyperson.ui.mybookmark.popup.actions;
...
public class MyMarkerRulerAction extends ResourceAction implements IUpdate{
	 ...
	 */
	public MyMarkerRulerAction(ResourceBundle bundle, String prefix, IVerticalRuler ruler, ITextEditor editor, String markerType, boolean askForLabel) {
	...
	protected List getMarkers() {
		...
		if (resource != null && model != null && resource.exists()) {
			try {
				...
				handleCoreException(x, Messages.MarkerRulerAction_getMarker);
			}
		}
	...
	private String getOperationName() {
		String name= getText();
		return name == null ? Messages.AddMarkerAction_addMarker : name;
	}
