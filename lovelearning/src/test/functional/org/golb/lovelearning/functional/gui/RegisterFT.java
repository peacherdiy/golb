package org.golb.lovelearning.functional.gui;

import static org.junit.Assert.*;

import org.junit.Test;
import org.openqa.selenium.By;
import org.golb.lovelearning.functional.BaseSeleniumTestCase;
...
public class RegisterFT extends BaseSeleniumTestCase {
	...
	public void register() {
		...
		//跳转到登录页
		assertEquals("lovelearning示例:登录页", s.getTitle());
		...
		//登陆成功
		assertEquals("lovelearning示例:任务管理", s.getTitle());
